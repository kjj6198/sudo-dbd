...
/***/ function(module, exports, __webpack_require__) {
	...
	shrimpClicks.throttle(animateTime).forEach(function (click) {
	    fancyShrimp();
	});
	// animateFunction
	var fancyShrimp = function fancyShrimp() {
	    console.log('do');
	    flashAnimate($sdbdText);
	    cycleMove($shrimp);
	};
	var flashAnimate = function flashAnimate(elem) {
	    elem.css("opacity", 0);
	    elem.animate({
	        opacity: 1
	    }, animateTime);
	};
	var cycleMove = function cycleMove(elem) {
...
/***/ function(module, exports) {
	...
	var $activeCountDowns = $(".countDown").toArray().map(function (element) {
	    return $(element);
	}).filter(activeOrNot);
	...
	setInterval(function () {
	    timers = timers.map(function (timer) {
